...
seconds_ring_fill_color  = {0xFFFFFF, 0.2}, -- fill color
seconds_ring_fill_colorS = {0xFFFFFF, 0.2},
...
fill_color       = {0xFFFFFF, 0.6},   -- fill color for hour+minutes ring
fill_colorS      = {0xFFFFFF, 0.6},   -- fill color for seconds ring
